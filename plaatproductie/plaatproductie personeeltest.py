...
class totaal():
    ...
    def klein_hand(sg):
        ...
        personeel = aantal_jaar*(50/0.35)*(nplaat + 4 + Llas_plaat/15 +(Llas_vrang_verti/1.2 +(Llas_vrang_hori+Llas_zaathout)/2)*(7.8*tp**2/200) +1/2*(nspant)+2*(nvrang+nzaathout))
    ...
    def groot_hand(sg):
        ...
        personeel = aantal_jaar*50/0.35*(nplaat + 4 + Llas_plaat/15 +(Llas_vrang_verti/1.2 +(Llas_vrang_hori+Llas_zaathout)/2)*(7.8*tp**2/200) +1/2*(nspant)+4*(nvrang+nzaathout))
    ...
    def klein_robot(sg):
        ...
        personeel = aantal_jaar*90/0.60*(nplaat + 4 + Llas_plaat/30 +(Llas_vrang_verti/2.4 +(Llas_vrang_hori+Llas_zaathout)/4)*(7.8*tp**2/200) +1/2*(nspant)+2*(nvrang+nzaathout))
    ...
    def groot_robot(sg):
        ...
        personeel = aantal_jaar*90/0.60*(nplaat + 4 + Llas_plaat/30 +(Llas_vrang_verti/2.4 +(Llas_vrang_hori+Llas_zaathout)/4)*(7.8*tp**2/200)+ 1/2*(nspant)+4*(nvrang+nzaathout))
